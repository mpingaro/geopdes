...
function sp = sp_nurbs_2d (varargin)
  ...
  nodes = msh.qn;
  sp.spu = sp_bspline_1d_param (sp.knots{1}, sp.degree(1), nodes{1}, 'gradient', true, 'hessian', true, 'der3', true);
  sp.spv = sp_bspline_1d_param (sp.knots{2}, sp.degree(2), nodes{2}, 'gradient', true, 'hessian', true, 'der3', true);
