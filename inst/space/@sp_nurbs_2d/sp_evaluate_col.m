...
%    shape_function_der3
%             (2 x 2 x msh_col.nqn x nsh_max x msh_col.nel)  third derivatives of basis functions evaluated at each quadrature node in each element
%
