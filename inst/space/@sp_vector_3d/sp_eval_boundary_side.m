...
function sp_bnd = sp_eval_boundary_side (sp, msh_side)
  ...
  sp_bnd.shape_functions_gradients = zeros (3, msh_side.nqn, sp_bnd.nsh_max, msh_side.nel);
  sp_bnd.shape_functions_gradients(1,:,1:sp_bnd1.nsh_max,:) = sp_bnd1.shape_functions_gradients;
  sp_bnd.shape_functions_gradients(2,:, sp_bnd1.nsh_max+(1:sp_bnd2.nsh_max),:) = sp_bnd2.shape_functions_gradients;
  sp_bnd.shape_functions_gradients(3,:, sp_bnd1.nsh_max+sp_bnd2.nsh_max+(1:sp_bnd3.nsh_max),:) = sp_bnd3.shape_functions_gradients;
