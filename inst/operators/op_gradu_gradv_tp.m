...
function varargout = op_gradu_gradv_tp (space1, space2, msh, coeff)
  ...
  for iel = 1:msh.nel_dir(1)
    ...
    sp1_col = sp_evaluate_col (space1, msh_col, 'value', false, 'gradient', true, 'hessian', false);
    sp2_col = sp_evaluate_col (space2, msh_col, 'value', false, 'gradient', true, 'hessian', false);
