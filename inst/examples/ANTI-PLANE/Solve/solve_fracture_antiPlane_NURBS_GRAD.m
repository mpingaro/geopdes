...
msh      = msh_2d (zeta, qn, qw, geometry,'der2', true, 'der3', true);
...
for iside = nmnn_sides
   ...
   if iside == 1
      ...
      sp_normal = sp_normal_tang_circ(sp_side_col, msh_col, normal, 'gradient', true,'hessian', true, 'der3', true);
   ...
   elseif iside == 4
      ...
      sp_side_row = sp_evaluate_row(space_side,msh_row,'gradient', true, 'hessian', true, 'der3', true);
      % Normal and Tangent derivatives
      sp_normal = sp_normal_tang_circ(sp_side_row, msh_row, normal, 'gradient', true,'hessian', true, 'der3', true);
      
      sp_boundary = sp_side_row;
   end
   
   stiff_mat2 = stiff_mat2 + op_Bordo_Fracture(sp_boundary, sp_normal, msh_side);
 
end
stiff_mat = stiff_mat1 + copp.*stiff_mat2;
