% SOLVE_BILAPLACE_2D_FRAC_ISO: Solve a 2d Bi-Laplace problem with a NURBS discretization (isoparametric approach). 
...
% u = zeros (space.ndof, 1);
% % Apply Dirichlet boundary conditions (edge 1 3 4)
