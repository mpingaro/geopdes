...
p=polyfit(leap_SG_COMP(:,1),leap_SG_COMP(:,2),19);
y=polyval(p,leap_SG_COMP(:,1));
%figure, plot(leap_SG_COMP(:,1),leap_SG_COMP(:,2),leap_SG_COMP(:,1),y);
figure, plot(leap_SG_COMP(:,1),leap_SG_COMP(:,2));
