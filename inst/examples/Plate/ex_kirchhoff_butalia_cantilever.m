% EX Kirchhoff.
% Trapezoidal plate clamped in one edge and uniformaly distributed load.
clear; 
close all; 
clc;
%--------------------------------------------------------------------------
...
problem_data.bound_sides    = [2,3,4]; % Define free edges (Boundary integrals)
problem_data.drchlt_sides_u = 1;       % Define Dirichlet conditions u
problem_data.drchlt_sides_r = 1;       % Define Dirichlet condition du/dn
