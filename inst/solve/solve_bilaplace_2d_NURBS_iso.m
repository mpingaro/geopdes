% SOLVE_BILAPLACE_2D_NURBS_ISO: Solve a 2d Bi-Laplace problem with a NURBS discretization (isoparametric approach). 
%
...
% USAGE:
%
%  [geometry, msh, space, u] = solve_bilaplace_2d_NURBS_iso (problem_data, method_data)
%
% INPUT:
%
...
%
% See also EX_KIRCHHOFF_PLATENURBS for an example.
% See also EX_KIRCHHOFF_CIRCULARNURBS for an example.
%
% Copyright (C) 2009, 2010, 2011 Carlo de Falco
% Copyright (C) 2011, Rafael Vazquez
% Copyright (C) 2013, Rafael Vazquez, Marco Pingaro
...
for iside = bound_sides
  ...
  if iside == 1
      ...
      bordo = op_bordo_plate_laplace(sp_boundary, sp_normal, msh_side, poisson);
